...
public class DemoEdmProvider extends CsdlAbstractEdmProvider {
    ...
    // Entity Types Names
    public static final String ET_ORDER_NAME = "Product";
    public static final FullQualifiedName ET_ORDER_FQN = new FullQualifiedName(NAMESPACE, ET_PRODUCT_NAME);
    ...
    public CsdlEntityType getEntityType(FullQualifiedName entityTypeName) {
        ...
        if (entityTypeName.equals(ET_PRODUCT_FQN)) {
            ...
            entityType.setProperties(Arrays.asList(id, name, description, price, weight));
            ...
            entityType.setProperties(Arrays.asList(id, timestamp));
            entityType.setKey(Collections.singletonList(propertyRef));
